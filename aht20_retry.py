...
Coherent avec le pattern DHT22 de la semaine 2
...
# Constantes de retry (memes que semaine 2)
MAX_TENTATIVES = 3
...
if __name__ == '__main__':
    ...
    print(f"Delai entre tentatives : {DELAI_RETRY}s")
    print()
    # Lecture avec retry
...
if donnees['valide']:
    ...
    print("ERREUR : Echec lecture apres plusieurs tentatives")
    print("Verifiez :")
